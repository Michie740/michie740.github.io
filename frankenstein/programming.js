$(document).ready(function(){
    ...
    $(".monster").mouseenter(function(){
        $(".monster").css("backgroundColor", "rgb(134, 192, 240)")
    })
    $(".monster").mouseleave(function(){
        $(".monster").css("backgroundColor", "rgb(253, 196, 241)")
    })
    $(".bearie").mouseenter(function(){
        $(".bearie").css("backgroundColor", "rgb(134, 192, 240)")
    })
    $(".bearie").mouseleave(function(){
        $(".bearie").css("backgroundColor", "rgb(253, 196, 241)")
    })
    ...
    $(".monster").click(function(){
        $(".content").hide()
        $(".frankenstein").show()
        $("header").css("backgroundColor", "#638b27")
        $(".navigation").css("backgroundColor", "#638b27")
        $(".monster").css("backgroundColor", "#638b27")
        $(".bearie").css("backgroundColor", "#638b27")
        $(".monster").mouseenter(function(){
            $(".monster").css("backgroundColor", "black")
        })
        $(".monster").mouseleave(function(){
            $(".monster").css("backgroundColor", "#638b27")
        })
        $(".bearie").mouseenter(function(){
            $(".bearie").css("backgroundColor", "black")
        })
        $(".bearie").mouseleave(function(){
            $(".bearie").css("backgroundColor", "#638b27")
        })
    })
    $(".bearie").click(function(){
        $(".frankenstein").hide()
        $(".content").show()
        $("header").css("backgroundColor",  "rgb(253, 196, 241)")
        $(".navigation").css("backgroundColor", "rgb(253, 196, 241)")
        $(".monster").css("backgroundColor", "rgb(253, 196, 241)")
        $(".bearie").css("backgroundColor", "rgb(253, 196, 241)")
         $(".monster").mouseenter(function(){
            $(".monster").css("backgroundColor", "rgb(134, 192, 240)")
